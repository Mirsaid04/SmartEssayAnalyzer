...
const App = () => {
  ...
  const handleSend = async () => {
    try {
      ...
      const response = await fetch('https://smartessaychecker-77bbb191090c.herokuapp.com/api/Home', {
        method: 'POST',
        headers: {
    ...
    <div className="container">
      ...
      <div className="social-icons" style={{display: "flex", alignItems: "center", justifyContent: "space-between", marginRight: "100px"}}>
          ...
          <div style={{display:"flex", alignContent:"center", marign:"0px"}}>
            <h3 style={{margin: "0", marginRight: "20px"}}>Contact support: </h3>
            <a href="mailto:mirsaidd04@gmail.com" target="_blank" rel="noopener noreferrer">              
              <img style={{height: "40px", width:"40px"}} src={gmail}></img>
            </a>
